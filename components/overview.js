...
export default function Overview({ transfers, tokens }) {
    ...
    return (
        <div className="grid sm:grid-cols-2 max-w-xs justify-center items-center mx-auto col-2 space-y-2">
            <div className="shadow-lg border mx-auto rounded-xl w-32 h-20 p-4 bg-white  relative overflow-hidden">
            ...
            <div className="shadow-lg border rounded-xl mx-auto max-w-xs p-4 bg-white relative overflow-hidden">
                <div className=" flex w-60 items-center justify-between mb-6">
                ...
                <div className="flex items-center mb-2 rounded justify-between p-3 bg-red-100">
                    <span className="rounded-lg p-2 bg-white">
